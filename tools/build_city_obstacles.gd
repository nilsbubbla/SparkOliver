...
const OUT_PATH := "res://assets/obstacles/city_obstacles_sheet.png"
const FRAME_SIZE := Vector2i(256, 192)
const MAX_CONTENT := Vector2i(224, 168)

const SOURCE_FILES: Array[String] = [
	"res://Sprites/Bakgrund/Hinder/trafikkon.png",
	"res://Sprites/Bakgrund/Hinder/metallbarriar_med_varningsljus.png",
	"res://Sprites/Bakgrund/Hinder/tradbarriar_med_varningsrander.png",
	"res://Sprites/Bakgrund/Hinder/parkbank.png",
	"res://Sprites/Bakgrund/Hinder/cykel_med_stall.png",
	"res://Sprites/Bakgrund/Hinder/kartongstapel.png",
	"res://Sprites/Bakgrund/Hinder/vattenpol.png",
	"res://Sprites/Bakgrund/Hinder/potthal.png",
	"res://Sprites/Bakgrund/Hinder/busshallplatsskylt.png",
	"res://Sprites/Bakgrund/Hinder/gatupollare.png",
]

func _initialize() -> void:
	DirAccess.make_dir_recursive_absolute(ProjectSettings.globalize_path("res://assets/obstacles"))
	...
	for i in range(SOURCE_FILES.size()):
		...
		if bounds.size.x <= 0 or bounds.size.y <= 0:
			push_error("No visible pixels in " + SOURCE_FILES[i])
			quit(1)
			return
		...
		var dst := Vector2i(
			i * FRAME_SIZE.x + int((FRAME_SIZE.x - fitted.get_width()) * 0.5),
			FRAME_SIZE.y - fitted.get_height() - 8
		)
	...
	print("Built city obstacle atlas: ", OUT_PATH)
	quit()
